...
<body>
        ...
        <div id="tableWrapper" style="overflow-x:auto;">
            <table id="attendanceTable" class="attendance-table">
                ...
                <tbody>
                    ...
                    // Dummy data array 
                    $attendanceData = [
                        ["2024-03-15", "Meeting", "John Doe", "123456", "ABC Company", "08:00 AM", "05:00 PM", ""],
                        ["2024-03-16", "Training", "Jane Smith", "789012", "XYZ School", "09:00 AM", "04:00 PM", ""],
                        ["2024-03-15", "Meeting", "John Doe", "123456", "ABC Company", "08:00 AM", "05:00 PM", ""],
                        ["2024-03-16", "Training", "Jane Smith", "789012", "XYZ School", "09:00 AM", "04:00 PM", ""],
                        ["2024-03-15", "Meeting", "John Doe", "123456", "ABC Company", "08:00 AM", "05:00 PM", ""],
                        ["2024-03-16", "Training", "Jane Smith", "789012", "XYZ School", "09:00 AM", "04:00 PM", ""],
    ...
    <div class="modal" id="myModal">
        ...
        <h1 class="form-title">Visitor Attendance</h1>
        <hr class="divider">
        <form class="form" id="attendanceForm">
                ...
                <div class="date-field">
                    ...
                    <div class="control-container">
                        ...
                        <div class="select-control-container">
                            <select id="control" name="control" class="form-control-no">
                                <!-- Loop to generate options from 1 to 40 -->
                                <?php for ($i = 1; $i <= 40; $i++) { ?>
                                    <option value="purpose<?php echo $i; ?>">
                                        <?php echo $i; ?>
                                    </option>
                                <?php } ?>
                            </select>
            ...
            <div class="form-group">
                <label for="visitorAddress">School/Company:</label>
                <input type="text" id="visitorAddress" name="visitorAddress" class="form-control">
            </div>
