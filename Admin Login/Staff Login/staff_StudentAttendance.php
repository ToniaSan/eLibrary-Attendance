...
<body>
    ...
    <div class="db-staff-page">
        ...
        <div id="tableWrapper" style="overflow-x:auto;">
            <table id="attendanceTable" class="attendance-table">
                ...
                <tbody>
                    ...
                    // Dummy data array 
                    $attendanceData = [
                        ["2024-03-15", "Meeting", "John Doe", "123456", "IT", "08:00 AM", "05:00 PM", ""],
                        ["2024-03-16", "Training", "Jane Smith", "789012", "HR", "09:00 AM", "04:00 PM", ""],
                        ["2024-03-15", "Meeting", "John Doe", "123456", "IT", "08:00 AM", "05:00 PM", ""],
                        ["2024-03-16", "Training", "Jane Smith", "789012", "HR", "09:00 AM", "04:00 PM", ""],
                        ["2024-03-15", "Meeting", "John Doe", "123456", "IT", "08:00 AM", "05:00 PM", ""],
                        ["2024-03-16", "Training", "Jane Smith", "789012", "HR", "09:00 AM", "04:00 PM", ""],
        ...
        <div class="modal" id="myModal">
            ...
            <h1 class="form-title">Student Attendance</h1>
            <hr class="divider">
            <form class="form" id="attendanceForm">
                <!-- Form content as provided in your code -->
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", ".out", function () {
                ...
                row.find("td:nth-child(8)").text("OUT");
        ...
        // Handle click event for the modal close button
